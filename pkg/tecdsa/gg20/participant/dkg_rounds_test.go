...
func TestDkgRound3Works(t *testing.T) {
	...
	share1 := v1.NewShamirShare(1, participants[1].State.ShamirShare.Bytes(), field)
	share2 := v1.NewShamirShare(2, participants[2].State.ShamirShare.Bytes(), field)
	share3 := v1.NewShamirShare(3, participants[3].State.ShamirShare.Bytes(), field)
...
func TestDkgRound4Works(t *testing.T) {
	...
	shamir, _ := v1.NewShamir(playerMin, playerCnt, field)
	share1 := v1.NewShamirShare(1, out1.ShamirShare.Bytes(), field)
	share2 := v1.NewShamirShare(2, out2.ShamirShare.Bytes(), field)
	share3 := v1.NewShamirShare(3, out3.ShamirShare.Bytes(), field)
	secret12, err := shamir.Combine(share1, share2)
	require.NoError(t, err)
	secret13, err := shamir.Combine(share1, share3)
	require.NoError(t, err)
